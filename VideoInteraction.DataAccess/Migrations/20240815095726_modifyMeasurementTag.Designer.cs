...
namespace VideoInteraction.DataAccess.Migrations
{
    ...
    [Migration("20240815095726_modifyMeasurementTag")]
    partial class modifyMeasurementTag
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VideoInteraction.Models.Camera", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTs = new DateTime(2024, 8, 15, 16, 57, 25, 188, DateTimeKind.Local).AddTicks(8772),
                            Description = "",
                            Name = "Cam01"
                        },
                        new
                        {
                            ...
                            CreatedTs = new DateTime(2024, 8, 15, 16, 57, 25, 188, DateTimeKind.Local).AddTicks(8773),
                            Description = "",
                            Name = "Cam02"
                        },
                        new
                        {
                            ...
                            CreatedTs = new DateTime(2024, 8, 15, 16, 57, 25, 188, DateTimeKind.Local).AddTicks(8775),
                            Description = "",
                            Name = "Cam03"
                        });
                });
            ...
            modelBuilder.Entity("VideoInteraction.Models.CameraControlTag", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CameraId = 1,
                            CreatedTs = new DateTime(2024, 8, 15, 16, 57, 25, 188, DateTimeKind.Local).AddTicks(8863),
                            Description = "tag1",
                            TagName = "TDC_Com.TDC1.Tag1",
                            UpdatedTs = new DateTime(2024, 8, 15, 16, 57, 25, 188, DateTimeKind.Local).AddTicks(8863)
                        },
                        new
                        {
                            Id = 2,
                            CameraId = 2,
                            CreatedTs = new DateTime(2024, 8, 15, 16, 57, 25, 188, DateTimeKind.Local).AddTicks(8865),
                            Description = "tag2",
                            TagName = "TDC_Com.TDC1.Tag2",
                            UpdatedTs = new DateTime(2024, 8, 15, 16, 57, 25, 188, DateTimeKind.Local).AddTicks(8865)
                        },
                        new
                        {
                            Id = 3,
                            CameraId = 3,
                            CreatedTs = new DateTime(2024, 8, 15, 16, 57, 25, 188, DateTimeKind.Local).AddTicks(8867),
                            Description = "tag3",
                            TagName = "TDC_Com.TDC1.Tag3",
                            UpdatedTs = new DateTime(2024, 8, 15, 16, 57, 25, 188, DateTimeKind.Local).AddTicks(8867)
                        },
                        new
                        {
                            Id = 4,
                            CameraId = 4,
                            CreatedTs = new DateTime(2024, 8, 15, 16, 57, 25, 188, DateTimeKind.Local).AddTicks(8869),
                            Description = "tag4",
                            TagName = "TDC_Com.TDC1.Tag4",
                            UpdatedTs = new DateTime(2024, 8, 15, 16, 57, 25, 188, DateTimeKind.Local).AddTicks(8869)
                        });
                });
